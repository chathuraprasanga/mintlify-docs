...
On the left side of your screen, you will see the button "Purchasing." Clicking on it will expand the sub-menu items. There, you will see the **Intakes** button. Click it and then click on **Create Intake** to submit a simple request.
...
On the left side of your screen you can see the button Purchasing. Clicking on Purchasing will expand the sub-menu items. There you have the **Requisitions** button. Click it and click on Create Requisition.
...
To create a purchase order from scratch, go to Purchasing on the left side of your screen and click on Purchase Orders in the sub-menu. At the right upper corner you have the **Create Purchase Order** button. Click it and fill all required data and add the line items with their information. Saving it will submit for approval.
...
Access the received notes page from Receiving > Received Notes. All created Received Notes are listed in a tabular view.
<Frame>
...
When rejecting a received note, the approver has the option to save its details as a returned note. Created returned notes can be accessed under the Returned Notes tab (Receiving > Received Notes > Returned Notes).
...
To manage invoices and process them into payments, navigate to Accounts Payable > Invoices. Here, users can review all submitted invoices.
<Frame>
...
To upload an invoice, navigate to Purchasing > Purchase Orders. Open the relevant PO and click Upload Invoice.
<Frame>
...
To view an uploaded invoice, go to Accounts Payable > Invoices. Initially, the invoice status will be set to "Queued". Once the invoice is successfully processed, the status will change to "Approval Pending" or "Approved" depending on the approval workflow set for invoices in the system. If the invoice does not require any approvals, it will be automatically approved and ready for payment.
...
To access it, go to Accounts Payable in the main menu and click on 2-way/3-way Matching.
<Frame>
...
To access the report, go to Accounts Payable in the main menu and click on Duplicate Invoice Detection.
<Frame>
...
Go to Reports in the main menu and click on 'Insights.' There, you can select a type of procurement document and a time period to view a list of created documents along with summary details.
<Frame>
