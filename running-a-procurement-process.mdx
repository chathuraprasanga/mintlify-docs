...
When rejecting a received note, the approver has the option to save its details as a returned note. Created returned notes can be accessed under the Returned Notes tab (`Receiving` >
<a href="https://buyer.proculy.com/app/good-receiving/notes" target="_blank">`Received Notes`</a> > <a
    href="https://buyer.proculy.com/app/good-receiving/notes" target="_blank">`Received Notes`</a>).
