...
On the left side of your screen, you will see the button "Purchasing." Clicking on it will expand the sub-menu items. There, you will see the <a href="https://qa-client.proculy.com/app/request" target="_blank">Intakes</a> button. Click it and then click on <a href="https://qa-client.proculy.com/app/request/create-new-request" target="_blank">Create Intakes</a>  to submit a simple request.
...
On the left side of your screen you can see the button Purchasing. Clicking on Purchasing will expand the sub-menu items. There you have the <a href="https://qa-client.proculy.com/app/requisitions" target="_blank">Requisitions</a> button. Click it and click on <a href="https://qa-client.proculy.com/app/requisitions/create-new" target="_blank">Create Requisitions</a>.
...
Access the received notes page from Receiving > <a href="https://qa-client.proculy.com/app/good-receiving/notes" target="_blank">Received Notes</a>. All created Received Notes are listed in a tabular view.
<Frame>
...
Note: You cannot select a purchase order if a received note for it is still pending approval or in draft status. To prevent duplication, only one received note can be created at a time for the same order.
...
When rejecting a received note, the approver has the option to save its details as a returned note. Created returned notes can be accessed under the Returned Notes tab (Receiving > <a href="https://qa-client.proculy.com/app/good-receiving/notes" target="_blank">Received Notes</a> > <a href="https://qa-client.proculy.com/app/good-receiving/notes" target="_blank">Received Notes</a>).
...
To manage invoices and process them into payments, navigate to Accounts Payable > <a href="https://qa-client.proculy.com/app/invoices" target="_blank">Invoices</a>. Here, users can review all submitted invoices.
<Frame>
...
To upload an invoice, navigate to Purchasing ><a href="https://qa-client.proculy.com/app/orders" target="_blank">Purchase Orders</a>. Open the relevant PO and click Upload Invoice.
<Frame>
...
To view an uploaded invoice, go to Accounts Payable > <a href="https://qa-client.proculy.com/app/invoices" target="_blank">Invoices</a>. Initially, the invoice status will be set to "Queued". Once the invoice is successfully processed, the status will change to "Approval Pending" or "Approved" depending on the approval workflow set for invoices in the system. If the invoice does not require any approvals, it will be automatically approved and ready for payment.
...
1. Access Requisitions: Go to the requisition page via the main menu: Purchasing > Requisitions.
<Frame>
    <img src="/images/92.png" style={{borderRadius: '0.5rem'}}/>
</Frame>

2. Select Purchase Requisition: Choose the pending purchase requisition you want to create a request for quotes from. Click the action button and then “View”.

<Frame>
    <img src="/images/93.png" style={{borderRadius: '0.5rem'}}/>
</Frame>

3. Create RFQ: Select the line items (one or more) that need to be added to the request for quotes and click the “Create RFQ” button.
<Frame>
    <img src="/images/94.png" style={{borderRadius: '0.5rem'}}/>
</Frame>

4. Select Vendors and Details: Use the pagination bar or search bar to select vendors from the list. Choose a quoting end date and the currency for the quotes, then click the "Create RFQ" button. Confirm the creation by clicking the “Create” button in the pop-up.
<Frame>
...
Created requests for quotes will appear on the requests for quotes page, accessible via the main menu: Sourcing > Requests for Quotes.
...
A budget must be linked when creating a purchase order. The same budget will automatically be linked to any invoices generated for that order.
<Frame>
...
To access it, go to Accounts Payable in the main menu and click on <a href="https://qa-client.proculy.com/app/reports/matching_reports" target="_blank">2-way/3-way Matching</a>.
<Frame>
...
To access the report, go to Accounts Payable in the main menu and click on <a href="https://qa-client.proculy.com/app/reports/duplicates" target="_blank">Duplicate Invoice Detection</a>.
<Frame>
...
Go to Reports in the main menu and click on <a href="https://qa-client.proculy.com/app/reports/duplicates" target="_blank">Insights</a>.' There, you can select a type of procurement document and a time period to view a list of created documents along with summary details.
<Frame>
